=== ContentLead-WP-Plugin ===

Contributors: Brafton Inc.
Tags: ContentLEAD, Brafton, Castleford
...
PHP 5.3 or newer on your hosting server, with the DOMXML Library Installed.
...
We handle plug-in updates using github updater plugin by jkudish. If your version of the Brafton plugin is out of sync with this repositroy you will see a notification on your WordPress admin dashpanel's updates tab. Check it frequently to ensure you are running the latest version of our importer. Updating your plugin will replace your current version of the Brafton Plugin with the master branch on github.
