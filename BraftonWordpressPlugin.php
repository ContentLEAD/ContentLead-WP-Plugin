...
/* includes the update from Github code */
  ...
  if (is_admin()) { // note the use of is_admin() to double check that this is happening in the admin
      $config = array(
          ...
          'proper_folder_name' => 'ContentLead-WP-Plugin', // this is the name of the folder your plugin lives in
          ...
          'zip_url' => 'https://github.com/ContentLEAD/ContentLead-WP-Plugin/zipball/fixed-images.zip', // the zip url of the github repo
